      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-8 justify-center text-left">
          ...
          <div className="flex-1 bg-white/5 rounded-2xl p-6 shadow-lux-tag border border-indigo-200/10">
            ...
            <ul className="text-white/90 font-light list-disc ml-6">
              <li>ML pipelines with python</li>
              <li>Created React frontends with Node.js/Express.js and MongoDB</li>
              <li>Implemented NLP and RAG workflows using Hugging Face Transformers, FAISS, LangChain, prompt-engineered LLMs</li>
            </ul>
          </div>
        </div>
      </motion.div>
